...
CREATE TABLE `tbl_agenda` (
  ...
  `agenda_gambar` varchar(40) DEFAULT NULL
...
INSERT INTO `tbl_agenda` (`agenda_id`, `agenda_nama`, `agenda_tanggal`, `agenda_deskripsi`, `agenda_mulai`, `agenda_selesai`, `agenda_tempat`, `agenda_waktu`, `agenda_keterangan`, `agenda_author`, `agenda_gambar`) VALUES
(9, 'Wisuda', '2020-07-25 08:20:40', 'wisuda periode 3', '2020-07-07', '2020-07-30', 'JEC', '10:30', 'wisuda akbar', 'agung', 'a9338dd6f403bcb8068b26d08ac47730.jpg'),
(10, 'Seminar', '2020-07-25 08:21:38', 'ajsnjansasqddwdb', '2020-06-30', '2020-07-30', 'Hotel JEC', '09:00-12:00', 'Wajib', 'agung', '5951346a79720abf16a6ca51e063391e.jpg'),
(11, 'Kajian Ahad Pagi', '2020-07-25 08:22:53', 'namanya juga usaha ya harus semangat', '2020-07-09', '2020-07-24', 'Hongkong', '06:00-11:00', 'kasjajsnajd', 'agung', 'de0772a6ba546bfbba7331c4c2ad78e2.jpeg'),
(12, 'Kajian Senin Pagi', '2020-07-25 08:23:33', 'dddwdwdw', '2020-08-11', '2020-07-17', 'Musholla', '09:00', 'sadsd', 'agung', '4a5e7e32a6d16518498ec4bc6bfdcbd0.jpg'),
(13, 'Shalat Berjamaah', '2020-07-25 08:24:12', 'wud9 qdeufcuoeqb', '2020-07-19', '2020-07-28', 'Medan', '07:00', 'asadadasdad', 'agung', '0a85c91cbafbaf23c06652ecb681c70c.jpg');
...
CREATE TABLE `tbl_pengumuman` (
  ...
  `pengumuman_gambar` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_pengumuman` (`pengumuman_id`, `pengumuman_judul`, `pengumuman_deskripsi`, `pengumuman_tanggal`, `pengumuman_author`, `pengumuman_gambar`) VALUES
(10, 'Pencegahan Virus Corona', 'Dihimbau kepada seluruh civitas akademika UAD untuk selalu menjaga kebersihan dengan selalu mencuci tangan dengan sabun sebelum makan, serta menggunakan masker ketika beraktifitas di luar ruangan', '2020-07-25 08:25:07', 'agung', '1321d4f7845bc80be77d590da13a26fc.jpg'),
(11, 'Libur Akhir Tahun', 'Setelah libur semester ganjil tahun ajaran 2019-2020, proses Perkuliahan di semester genap tahun ajaran 2019-2020 mulai aktif kembali tanggal 2 Maret 2020', '2020-07-25 08:25:42', 'agung', '15fae80841d2050c1c55a68f9dbbfc89.JPG'),
(12, 'UAS GASAL', 'Libur semester ganjil tahun ajaran 2016-2017 dimulai dari tanggal 3 Maret 2017 sampai dengan tanggal 7 Maret 207.', '2020-07-25 08:26:26', 'agung', '83eba85a8613dc5a21a00322bf5b095e.JPG'),
(13, 'UTS SEMESTER GENAP 2020', 'Berhasil untuk Jujur', '2020-07-25 08:26:47', 'agung', '74c118d5a438e94094e38057cebdd19c.JPG'),
(14, 'Ramadhan Berbagi', 'dnond ednje nqwndnuf udbfi dsbfsnfj;khasbdfbwf', '2020-07-25 08:27:14', 'agung', '356ea3ae6c5bf53f234c04419ca6041f.JPG');
...
(959, '2020-07-24 00:30:20', '::1', 'Firefox'),
(960, '2020-07-24 00:44:15', '127.0.0.1', 'Firefox'),
(961, '2020-07-25 06:22:19', '::1', 'Chrome'),
(962, '2020-07-25 06:38:41', '127.0.0.1', 'Firefox');
...
--
ALTER TABLE `tbl_pengunjung`
  MODIFY `pengunjung_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=963;
