...
<section class="welcome_about">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
              <h2>Sambutan Kepala Bimawa UAD</h2>
               <h3>Dr. Dedi Pramono, M.Hum</h3>
               ...
               <br><br>
               <p>Berdasarkan Surat Keputusan Rektor Universitas Ahmad Dahlan Nomor 177 Tahun 2020 Tentang Perubahan Visi, Misi, dan Tujuan Biro Kemahasiswaan dan Alumni Universitas Ahmad Dahlan</p>
                <h2>Visi Bimawa</h2>
                <p>Menjadikan Biro yang mampu menyiapkan dan mengembangkan mahasiswa berkelas internasional dan dijiwai nilai-nilai islam
                </p><br>
                 <h2>Misi Bimawa</h2>
                <p>1. Mendukung pencapaian visi dan misi UAD melalui pengelolaan dan pengembangan kemahasiswaan dan alumni<br>
                  2. Melaksanakan sosialisasi program pelayanan, pengelolaan, pembinaan dan pengembangan<br>
                  3. Melaksanakan program pelayanan dan kegiatan awal bagi mahasiswa baru<br>
                  4. Melaksanakan pengelolaan dan pengembangan kegiatan kemahasiswaan<br>
                  5. Melaksanakan pengelolaan dan pengembangan bagi kesejahteraan mahasiswa<br>
                  6. Melaksanakan pemberdayaan alumni</p><br>
                
                 <h2>Tujuan</h2>
                <p>1.Terwujudnya pencapaian visi dan misi Biro Kemahasiswaan dan Alumni melalui pengelolaan dan pengembangan kemahasiswaan dan alumni.<br>
                   2. Terselenggaranya sosialisasi program pelayanan, pengelolaan, pembinaan dan pengembangan kegiatan kemahasiswaan dan alumni ke seluruh stakeholder secara teratur.<br>
                   3. Terlaksananya program pelayanan dan kegiatan bagi mahasiswa baru.<br>
                   4. Terlaksananya pengelolaan dan pengembangan kegaiatn kemahasiswaan tingkat nasional dan internasional.<br>
                   5. Terlaksananya pengelolaan dan pengembangan bagi kesejahteraan mahasiswa berupa layanan kesehatan, <br>
                   6. beasiswa, dan layanan bimbingan konseling.<br>
                   7. Terlaksananya pemberdayaan alumni dan program tracer study, inkubasi kewirausahaan tahap lanjut, pengembangan amal usaha di daerah.</p>
                </div>
                <div class="col-md-5">
                    <img src="<?php echo base_url().'theme/images/bim.jpg'?>" class="img-fluid" alt="#">
                </div>
            </div>
        </div>
    </section>
