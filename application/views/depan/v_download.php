            ...
            <div class="col-md-3">
                ...
                <div class="col-md-3">
                  <div class="sitemap">
                      <h3>Biro/Lembaga</h3>
                      <ul>
                          <li><a href="<?php echo site_url('baa.uad.ac.id');?>">BAA UAD</a></li>
                          <li><a href="<?php echo site_url('siswa');?>">BISKOM </a></li>
                          <li><a href="<?php echo site_url('pengumuman');?>">BPM UAD</a></li>
                          <li><a href="<?php echo site_url('agenda');?>">CDC UAD</a></li>
                          <li><a href="<?php echo site_url('download');?>">LPSI</a></li>
                      </ul>
                  </div>
                </div>
                <div class="col-md-3">
