              ...
              <?php foreach ($data->result() as $row) : ?>
                <div class="blog-single-item">
                    ...
                    <div class="blog-tiltle_block">
                        ...
                        <h6> 
                          <a href="#"><i class="fa fa-user" aria-hidden="true"></i><span><?php echo $row->tulisan_author;?></span> </a>  |   
                          <a href="#"><i class="fa fa-tags" aria-hidden="true"></i><span><?php echo $row->tulisan_kategori_nama;?></span></a>
                        </h6>
                        <?php echo limit_words($row->tulisan_isi,20).'...';?>
                ...
                <div class="blog-featured_post">
                    ...
                    <?php foreach ($populer->result() as $row) :?>
                      <div class="blog-featured-img_block">
                          ...
                          <h5>
                            <a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>"><?php echo limit_words($row->tulisan_judul,3).'...';?>
                            </a>
                          </h5>
